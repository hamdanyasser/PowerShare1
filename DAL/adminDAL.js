...
class AdminDAL {
    ...
    // Get total generator owners count
    ...
    // Get pending issues count (overdue bills + inactive generators)
    ...
    // Get user growth statistics (month by month)
    ...
    // Get generator owner growth statistics
    ...
    async getUserDetailById(userId) {
        ...
        // Get subscriptions (using monthly_price and amperage from your schema)
    ...
    // Get all generators with detailed stats
    ...
    // Get generator detail with all related data
    async getGeneratorDetailById(genId) {
        ...
        // Get subscribers (using monthly_price from your schema)
    ...
    // Get all payments with user and generator info
